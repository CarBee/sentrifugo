...
protected function _getAcl()
{
	...
	if(!isset($role))
		 ...
		 $acl->addResource(new GenericResource('timemanagement:index'));
									$acl->allow($tmroleText[$role], 'timemanagement:index', array('index','week','edit','view','getstates','converdate'));

		 $acl->addResource(new GenericResource('timemanagement:reports'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:expenses'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:expensecategory'));
									$acl->allow($tmroleText[$role], 'timemanagement:expensecategory', array('index','edit','view','delete'));

		 $acl->addResource(new GenericResource('timemanagement:projectresources'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:projects'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:projecttasks'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:notifications'));
		 ...
		 $acl->addResource(new GenericResource('timemanagement:employeeprojects'));
	   ...
	   $acl->addResource(new GenericResource('login:index'));	
	   ...
	   {				 		    	
		 ...
		 $acl->addResource(new GenericResource('default:appraisalmanager'));
		 ...
		 $acl->addResource(new GenericResource('default:employeeleavetypes'));
                    $acl->allow('admin', 'default:employeeleavetypes', array('index','view','edit','delete'));

		 $acl->addResource(new GenericResource('default:employmentstatus'));
                    $acl->allow('admin', 'default:employmentstatus', array('index','view','edit','delete','addpopup'));

		 $acl->addResource(new GenericResource('default:empscreening'));
		 ...
		 $acl->addResource(new GenericResource('default:myemployees'));
		 ...
		 $acl->addResource(new GenericResource('default:myholidaycalendar'));
                    $acl->allow('admin', 'default:myholidaycalendar', array('index','view','delete'));

		 $acl->addResource(new GenericResource('default:myteamappraisal'));
		 ...
		 $acl->addResource(new GenericResource('default:nationality'));
                    $acl->allow('admin', 'default:nationality', array('index','view','edit','delete','addpopup'));

		 $acl->addResource(new GenericResource('default:nationalitycontextcode'));
                    $acl->allow('admin', 'default:nationalitycontextcode', array('index','view','edit','delete'));

		 $acl->addResource(new GenericResource('default:numberformats'));
                    $acl->allow('admin', 'default:numberformats', array('index','add','view','edit','delete'));

		 $acl->addResource(new GenericResource('default:organisationinfo'));
		 ...
		 $acl->addResource(new GenericResource('default:payfrequency'));
                    $acl->allow('admin', 'default:payfrequency', array('index','addpopup','view','edit','delete'));

		 $acl->addResource(new GenericResource('default:pendingleaves'));
                    $acl->allow('admin', 'default:pendingleaves', array('index','view','delete'));

		 $acl->addResource(new GenericResource('default:policydocuments'));
		 ...
		 $acl->addResource(new GenericResource('default:requisition'));
		 ...
		 $acl->addResource(new GenericResource('expenses:myemployeeexpenses'));
                    $acl->allow('admin', 'expenses:myemployeeexpenses', array('index','view'));

		 $acl->addResource(new GenericResource('expenses:paymentmode'));
                    $acl->allow('admin', 'expenses:paymentmode', array('index','edit','delete'));

		 $acl->addResource(new GenericResource('expenses:receipts'));
	   ...
	   if($role == 2 )
		 ...
		 $acl->addResource(new GenericResource('default:servicerequests'));
		 ...
		 $acl->addResource(new GenericResource('default:hrwizard'));
